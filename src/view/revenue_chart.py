...
class RevenueChart(tk.Frame):
    ...
    def create_widgets(self):
        # --- Data Processing ---
        revenue_by_year = {}
        customer_count_by_year = {}
        province_revenue_by_year = {}

        for customer in self.customer_list:
            join_date_str = customer[6]
            revenue = customer[7] == "VIP" and customer[8] or customer[8]
            year = datetime.strptime(join_date_str, "%Y-%m-%d").year
            province = customer[5]
        ...
        notebook.add(revenue_frame, text="Total Revenue")
    ...
    def create_revenue_chart(self, parent, years, revenue_data):
        ...
        ax.set_ylabel("Total Revenue", fontsize=12, color="#333")
        ax.set_title("Total Revenue Over the Years", fontsize=14, color="#333")
    ...
    def create_customer_chart(self, parent, years, customer_data):
        ...
        ax.set_xlabel("Year", fontsize=12, color="#333")
        ax.set_ylabel("Number of Customers", fontsize=12, color="#333")
        ax.set_title("Customer Growth Over the Years", fontsize=14, color="#333")
        ax.tick_params(axis='x', colors='#555')
        ax.tick_params(axis='y', colors='#555')
        ax.spines['top'].set_visible(False)
        ax.spines['right'].set_visible(False)
    ...
    def create_province_revenue_chart(self, parent, years, province_revenue_data):
        ...
        ax.set_xlabel("Year", fontsize=12, color="#333")
        ax.set_ylabel("Revenue", fontsize=12, color="#333")
        ax.set_title("Revenue by Province Over the Years", fontsize=14, color="#333")
