...
class Camera(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        # ========================================================
        self.title_video = tk.Label(self.mainPanel,bg="#d4ffff",fg="#6f74ff",text="Motel Main Camera View", font=("Arial", 20,"bold"), anchor="center", justify="center",bd=0,padx=10,pady=10)
        self.show_camera = tk.Label(self.mainPanel,bg=color1,bd=0)
        self.notification_box = tk.Text(self.leftPanel, height=5, width=10, bg=color1, fg="black", state="disabled",bd=0,padx=10, pady=10)
        ...
        # add camera
        self.show_camera = tk.Label(self.mainPanel, bg=color1,height=1280,width=720)
